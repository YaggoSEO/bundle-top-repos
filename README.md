...
- [**Agency Agents**](https://github.com/msitarzewski/agency-agents): Colección de sistemas basados en IA diseñados para replicar los distintos roles operativos de una agencia de marketing tradicional (ventas, contenido, SEO, etc.) usando agentes de IA autónomos. *(Añadido por [@YaggoSEO](https://github.com/YaggoSEO))*
...
- [**Agents (wshobson)**](https://github.com/wshobson/agents): Ejemplos puros, minimalistas y funcionales para definir e integrar agentes de inteligencia artificial en aplicaciones productivas. *(Añadido por [@YaggoSEO](https://github.com/YaggoSEO))*
...
- [**Skill: Last 30 Days**](https://github.com/mvanhorn/last30days-skill?tab=readme-ov-file): Esta skill sirve para hacer “deep research” de cualquier tema usando las señales reales de lo que la gente está comentando y compartiendo en los últimos 30 días, buscando en fuentes como Reddit, X, Bluesky, YouTube, TikTok, Instagram, Hacker News, Polymarket y web. *(Añadido por [@YaggoSEO](https://github.com/YaggoSEO))*
...
- [**SEO GEO Audit**](https://github.com/GEO-SEO/seo-geo-audit): Herramienta centrada en "GEnerative Engine Optimization" y SEO tradicional. Extrae, monitoriza y analiza las webs contrastando tu contenido con cómo los LLMs y los grandes motores de búsqueda la ingieren y asimilan para generar sus respuestas. *(Añadido por [@YaggoSEO](https://github.com/YaggoSEO))*
